...
PI = 0
total_points = 0
for _ in range(10000000): # chosing a large number of points since this isn't a difficult computation
...
PI = 4 * (inside_circle / total_points) # calculating PI using the ratio of points in circle to total points
print("Approximation of PI given 10 million trials is", PI)